...
return [
    ...
    | ajustar cada uno de estos mensajes aquí.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas personalizadas de validación
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados para atributos
    | utilizando el formato "attribute.rule" para nombrar las líneas. Esto te
    | permite especificar un mensaje de lenguaje personalizado para una regla de
    | atributos determinada.
    |
    */
    ...
    | posición de atributos con algo más amigable para el lector, como "Correo
    | Electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer
    | nuestros mensajes más claros.
    |
    */
