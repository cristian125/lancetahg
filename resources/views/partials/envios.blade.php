<div class="d-flex justify-content-center align-items-start" style="min-height: 100vh; padding-top: 50px; width: 100%;">
        ...
        <ul class="nav nav-tabs justify-content-center" id="envioTabs" role="tablist" style="display: flex; flex-wrap: nowrap;">
            <li class="nav-item flex-fill text-center" role="presentation">
                <button class="nav-link active d-flex align-items-center justify-content-center" id="tienda-tab" data-bs-toggle="tab" data-bs-target="#tienda" type="button" role="tab" aria-controls="tienda" aria-selected="true">
                    <img src="/storage/img/envio_entrega/229.jpg" alt="Icono Recoger en Tienda" class="me-2 icon-small" />
                    <p class="mb-0"><span>Recoger</span> <span>en Tienda</span></p>
                </button>
            </li>
            <li class="nav-item flex-fill text-center" role="presentation">
                <button class="nav-link d-flex align-items-center justify-content-center" id="local-tab" data-bs-toggle="tab" data-bs-target="#local" type="button" role="tab" aria-controls="local" aria-selected="false">
                    <img src="/storage/img/envio_entrega/265.jpg" alt="Icono Envío Local" class="me-2 icon-small" />
                    <p class="mb-0"><span>Envío</span> <span>Local</span></p>
                </button>
            </li>
            <li class="nav-item flex-fill text-center" role="presentation">
                <button class="nav-link d-flex align-items-center justify-content-center" id="cobrar-tab" data-bs-toggle="tab" data-bs-target="#cobrar" type="button" role="tab" aria-controls="cobrar" aria-selected="false">
                    <img src="/storage/img/envio_entrega/266.jpg" alt="Icono Envío por Cobrar" class="me-2 icon-small" />
                    <p class="mb-0"><span>Envío</span> <span>Por Cobrar</span></p>
                </button>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="tienda" role="tabpanel" aria-labelledby="tienda-tab">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>Opción habilitada sólo para recoger en la <strong>Sucursal Hospital General</strong> en la Ciudad de México. <a href="/sucursales" title="Ver ubicación de la sucursal Hospital General" target="_parent">Ver ubicación.</a></p>
            ...
            <div class="tab-pane fade" id="local" role="tabpanel" aria-labelledby="local-tab">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4><i class="lnr lnr-chevron-right"></i> ¿TIENE COSTO?</h4>
                        <p>Sí, sólo cuando cumpla con el mínimo de compra para cada zona establecida. <a href="{{ route('coberturaloc') }}" target="_parent">Ver Cobertura Local</a></p>
                    </div>
                </div>
                <div class="content-notas mt-3">
                    <ol class="asterisco">
