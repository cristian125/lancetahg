<div id="modalEditarDireccion" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-lanceta text-white" style="width:100%;">
                <h5 class="modal-title"><i class="fa fa-pencil"></i> Editar Dirección</h5>
                <button class="btn btn-danger close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="frmEditarDireccion" action="{{route('cuenta.direccion.editar')}}" class="table" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button id="btnGuardarDireccion" class="btn btn-lanceta form-control bg-primary text-white">
