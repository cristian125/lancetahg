        ...
        <div class="accordion-body">
            <div class="row">
                <form id="frmDatos" action="{{ route('update.datos') }}" method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="tratamiento" class="form-label fw-bold">¿Cómo desea que nos dirijamos a
                                usted?</label>
                            <div class="input-group">
                                ...
                                <select name="tratamiento" id="tratamiento" class="form-select" required>
                                    ...
                                    <option value="NA"
                                        {{ $userData && $userData->tratamiento == 'NA' ? 'selected' : '' }}>Ninguno
                                    </option>
                                    <option value="Sr."
                                        {{ $userData && $userData->tratamiento == 'Sr.' ? 'selected' : '' }}>Sr.
                                    </option>
                                    <option value="Sra."
                                        {{ $userData && $userData->tratamiento == 'Sra.' ? 'selected' : '' }}>Sra.
                                    </option>
                                    <option value="Dr."
                                        {{ $userData && $userData->tratamiento == 'Dr.' ? 'selected' : '' }}>Dr.
                                    </option>
                                    <option value="Dra."
                                        {{ $userData && $userData->tratamiento == 'Dra.' ? 'selected' : '' }}>Dra.
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-control"
                                    value="{{ $user->name }}" maxlength="28" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="apellido_paterno" name="apellido_paterno" class="form-control"
                                    maxlength="28" placeholder="Apellido Paterno"
                                    value="{{ $userData ? $userData->apellido_paterno : '' }}" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="apellido_materno" name="apellido_materno" class="form-control"
                                    maxlength="28" placeholder="Apellido Materno"
                                    value="{{ $userData ? $userData->apellido_materno : '' }}" required>
                            </div>
                        </div>
                    </div>
                    <!-- Email -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" id="telefono" name="telefono" class="form-control"
                                    pattern="\d{10}" placeholder="Número Telefónico (10 dígitos)"
                                    value="{{ $userData ? $userData->telefono : '' }}" required>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#frmDatos').on('submit', function(e) {
            ...
            if (!validarLongitud('#nombre', "El nombre no puede tener más de 28 caracteres."))
            return false;
            if (!validarLongitud('#apellido_paterno',
                    "El apellido paterno no puede tener más de 28 caracteres.")) return false;
            if (!validarLongitud('#apellido_materno',
                    "El apellido materno no puede tener más de 28 caracteres.")) return false;
