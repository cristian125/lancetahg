...
<head>
    ...
    <title>Resumen del Pedido - LANCETA HG</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <!-- Título del Correo -->
        <h2>Nueva Orden de Pedido #{{ $order->id }}</h2>
        <p>Se ha realizado una nueva orden de pedido. A continuación, los detalles:</p>
...
<div class="product-details">
    ...
    @foreach ($orderItems as $item)
        <div class="product">
            ...
            <p class="product-price">Precio Unitario: ${{ number_format($item->unit_price, 2) }}</p>
            <p class="product-price">Precio Total: ${{ number_format($item->total_price, 2) }}</p>
        </div>
    @endforeach
</div>
        ...
        <!-- Total del Pedido -->
        <div class="total">
            Total del Pedido: ${{ number_format($order->total_con_iva, 2) }}
        </div>
