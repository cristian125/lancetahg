...
<body>
    <div style="background-color: #ffdddd; border: 2px solid #ff0000; color: #990000; padding: 20px; margin: 20px 0; border-radius: 10px; text-align: center; font-size: 18px;">
        <strong>ATENCIÓN:</strong> Este es un correo de prueba generado por el sistema de LANCETA HG. Por favor, si usted es el destinatario de este mensaje, ignórelo y no replique el mensaje.
    </div>
    ...
    <div class="container">
        ...
        <p>Le informamos que se ha generado un nuevo pedido web con el número <strong>#{{ $orderData->order_number }}</strong>, el cual debe ser procesado en su tienda.</p>
        ...
        <div class="order-container">
            <div class="order-header">
                <p>
                    ...
                    <strong>Método de Envío:</strong> {{ $orderData->shipment_method }}
                </p>
            </div>
        ...
        <div class="note">
            <p>
                ...
                Una vez que los productos estén listos, acceda al sistema de pedidos para visualizar los pedidos pendientes 
