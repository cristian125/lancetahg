...
Route::group(['middleware' => ['web']], function () {
    ...
    // Ruta para eliminar una imagen secundaria
    ...
    // Ruta para procesar el envío del enlace de recuperación de contraseña
    ...
    // Si deseas crear un controlador:
...
Route::prefix('adminlanz')->middleware('adminsession')->group(function () {
    ...
    // Rutas protegidas con el middleware 'auth:admin'
    Route::middleware(['auth:admin'])->group(function () {
        // Rutas accesibles por cualquier administrador autenticado
        ...
        // Rutas accesibles solo por 'superusuario'
        ...
        // Rutas accesibles por 'superusuario' y 'editor'
        Route::middleware('admin.role:superusuario,editor')->group(function () {
            ...
            // Rutas para la gestión de enlaces del footer
